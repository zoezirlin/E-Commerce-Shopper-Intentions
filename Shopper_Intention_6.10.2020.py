...
#logit_set = intention_df.iloc[:, [1,5,6,7,8,9]]
#print(logit_set)

#intention_df['intercept'] = 1.0

#boop = [intention_df['ExitRates'],
 #                 intention_df['BounceRates'],
  #                intention_df['PageValues'],
   #               intention_df['ProductRelated'],
    #              intention_df['ProductRelated_Duration'],
     #             intention_df['Administrative'],
      #            intention_df['intercept']
       #           ]



#logit = sm.Logit[intention_df['Revenue'],intention_df['boop']]

#this is the sm model for 'x' -  predictor variables
#X = intention_df[["ExitRates", 
 #                 "BounceRates", 
  #                "PageValues", 
   #               "ProductRelated",
